...
\begin{enumerate}
	...
	\begin{figure}[t]
		...
		\caption{Comparison of voltage input $u(t)$. Constraints are violated by the MPC controller. This is avoided by using a reference governor.}
		\label{VRFT_u}
	\end{figure} 
