...
\begin{enumerate}
	...
	\end{matrix}
	\end{equation*}
	The model has a deterministic input $v(t)$ and a disturbance input $w(t)$, which captures the effect of model uncertainties on system output. It is assumed that the disturbance input lies in a bounded set $\mathcal{W}_{\infty}$.
